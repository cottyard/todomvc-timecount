	...
	function (v) {
		return {
			tasks: _elm_lang$core$Native_List.toArray(v.tasks).map(
				function (v) {
					return {description: v.description, completed: v.completed, editing: v.editing, id: v.id, timeCount: v.timeCount, counting: v.counting};
				}),
			field: v.field,
			uid: v.uid,
	...
	var toTimeStamp = function (seconds) {
		var toStr = function (i) {
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				1) ? A2(_elm_lang$core$Basics_ops['++'], '0', s) : s;
		};
		return A2(
			_elm_lang$core$Basics_ops['++'],
			toStr((seconds / 3600) | 0),
			A2(
				_elm_lang$core$Basics_ops['++'],
				':',
				A2(
					_elm_lang$core$Basics_ops['++'],
					toStr(
						(A2(_elm_lang$core$Basics_ops['%'], seconds, 3600) / 60) | 0),
					A2(
						_elm_lang$core$Basics_ops['++'],
						':',
						toStr(
							A2(_elm_lang$core$Basics_ops['%'], seconds, 60))))));
	};
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'time ',
									todo.counting ? 'resumed' : 'paused'))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								toTimeStamp(todo.timeCount))
							])),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
